...
namespace fsu {
    ...
    void get_metrics_frame_file_path(const std::vector<cv::Mat>& video_frames, const int nframe, const std::string metrics_video_path, std::string& metrics_frame_file_path);
    ...
    void save_video_frame(const std::vector<cv::Mat>& video_frames, const int nframe, const cv::Mat& frame, const std::string& video_result_subdir);
    void save_video_metrics(const std::vector<cv::Mat>& video_frames, const int nframe, const std::string metrics_result, const std::string& video_result_subdir);
}
